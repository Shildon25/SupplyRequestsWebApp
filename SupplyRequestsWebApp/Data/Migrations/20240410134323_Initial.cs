        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveredByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemSupplyRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemSupplyRequests_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ItemSupplyRequests_SupplyRequests_SupplyRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemSupplyRequests_ItemId",
                table: "ItemSupplyRequests",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_ItemSupplyRequests_SupplyRequestId",
                table: "ItemSupplyRequests",
